...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -184.4095801466773; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -493.6498297735234; // x position of the perpendicular encoder (in tick units)
    }
