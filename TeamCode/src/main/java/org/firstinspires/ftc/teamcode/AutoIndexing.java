...
@Disabled
@Autonomous(name = "AutoIndexing", group = "Autonomous")
public class AutoIndexing extends LinearOpMode {
    @Override
    ...
    public class Launcher {
        ...
        private static final boolean USE_WEBCAM = true; //Means that the webacm is being used, and not a phone camera
